...
function wp_devops_current_sprint($atts = [], $content = null) {
	...
	print '<link rel="stylesheet" type="text/css" href="' . get_site_url() . '/wp-content/plugins/ucf-az-devops-rest-api/includes/timelinegraph.css"> ';
	print '<link rel="stylesheet" type="text/css" href="' . get_site_url() . '/wp-content/plugins/ucf-az-devops-rest-api/includes/popup.css"> ';
