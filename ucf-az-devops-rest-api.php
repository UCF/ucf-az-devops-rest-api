...
add_action( 'wp_enqueue_script', function() {
			...
			wp_enqueue_style( 'popup-css', get_site_url() . '/wp-content/plugins/ucf-az-devops-rest-api/includes/css/popup.css', false, '1.0.0', 'all');	
			
			wp_enqueue_style( 'timelinegraph-css', get_site_url() . '/wp-content/plugins/ucf-az-devops-rest-api/includes/css/timelinegraph.css' , false, '1.0.0', 'all');
